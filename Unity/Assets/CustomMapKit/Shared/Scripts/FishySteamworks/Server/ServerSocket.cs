...
namespace FishySteamworks.Server
{
	public class ServerSocket : CommonSocket
	{
		...
		private HashSet<HSteamNetConnection> _pendingAcceptedConnections;
		...
		private bool ShouldStopConnectionDueToFriendsOnlyLobbyAndPlayerNotBeingAFriend(ulong steamID)
		{
			return false;
		}
